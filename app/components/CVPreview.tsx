...
const CVPreview = React.forwardRef<HTMLDivElement, Props>(function CVPreview(
    { personalDetails, file, theme, experiences, educations, languages, skills, hobbies, download },
    ref,
) {
